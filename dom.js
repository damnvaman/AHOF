...
newItem.innerHTML = /* html */`
	...
	<div style="width: 300px;position: fixed;height: 20px;top: 10px;left: 300px;"> 
		...
		<label class="switch" style=" position: absolute; margin-top: 4px; margin-left: 3px; "> 
			<input type="checkbox" id="countrybanhistory" checked=""> 
	...
	<div style="width: 300px;position: fixed;height: 20px;top: 30px;left: 300px;"> 
		...
		<div style="position: absolute; margin-left: 38px;">No Same IP</div>
		
	</div><div style="position: absolute;width: 200px;right: 260px;top: 0px;color: #9CF;font-size: 1.1em;">
		<strong id="twicestat">0</strong> Seen more than once<br>
		<strong id="banstat">18</strong> Banned<br>
